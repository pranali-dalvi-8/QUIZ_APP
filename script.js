const questions=[
...

   {
    ...
    answers: [
       { text: "Konark Temple",correct:false},
       { text: "Khajuraho temples",correct:true},
       { text: "Mahabalipuram temples",correct:false},
       { text: "Sun temple",correct:false},
    ]
   },
   ...
   },
   {
    ...
    answers: [
       ...
       { text: "New York, USA",correct:true},
